...
Java_jp_ohwada_android_ndk3_MainActivity_stringFromJNI( JNIEnv* env, jobject thiz )
{
#if defined(__arm__)
...
JNIEXPORT jint JNICALL JNI_OnLoad(JavaVM* vm, void* reserved) {
    ...
    jclass  clz = (*env)->FindClass(env,
                                    "jp/ohwada/android/ndk3/JniHandler");
...
Java_jp_ohwada_android_ndk3_MainActivity_startTicks(JNIEnv *env, jobject instance) {
...
JNIEXPORT void JNICALL
Java_jp_ohwada_android_ndk3_MainActivity_StopTicks(JNIEnv *env, jobject instance) {
