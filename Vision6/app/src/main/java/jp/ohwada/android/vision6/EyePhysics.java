...
/**
 * class EyePhysics
 * Simulates the physics of motion for an iris which moves within a googly eye.  
 * The iris moves
 ...
 */
    public PointF nextIrisPosition(PointF eyePosition, float eyeRadius, float irisRadius) {
