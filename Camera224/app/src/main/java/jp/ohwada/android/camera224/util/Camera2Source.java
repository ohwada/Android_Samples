 ...
 * 2019-10-01 K.OHWADA
 */
package jp.ohwada.android.camera224.util;
...
public class Camera2Source extends Camera2Base {
    ...
    /**
     * Capture Request Tag for Color Effects
     */
    private final static String REQUEST_TAG_EFFECT = "effect";

    private final static String REQUEST_TAG_NONE = "";
 ...
 * doColorEffect
 */
public void doColorEffect(int effectId) {
        mEffectId = effectId;
    ...
    try {
        ...
        // new request
        mPreviewRequestBuilder.setTag(REQUEST_TAG_EFFECT); 
        ...
        mPreviewRequestBuilder.set(CaptureRequest.CONTROL_EFFECT_MODE, effectId);
...
protected void procCaptureCompleted( CameraCaptureSession session,
            ...
            if(REQUEST_TAG_EFFECT.equals(tag)) {
                procEffectCaptureCompleted( session, request, result);
            } else {
...
/**
 * procEffectCaptureCompleted
 */
private void procEffectCaptureCompleted( CameraCaptureSession session,
                                        CaptureRequest request,
                                       TotalCaptureResult result) {

                log_d("Effect is complete!");
...
private void resumeRepeatingRequest() {
        ...
        mPreviewRequestBuilder.setTag(REQUEST_TAG_NONE);
        ...
        // effect
        mPreviewRequestBuilder.set(CaptureRequest.CONTROL_EFFECT_MODE, mEffectId);
     ...
     */
    public void takePicture(int effectId, PictureCallback picCallback) {
        log_d("takePicture");
        isEffect = true;
        mEffectId = effectId;
  ...
  /**
    ...
    private void captureStillPicture() {
        ...
        captureBuilder.set(CaptureRequest.CONTROL_AWB_MODE,
            ...
            // effect
            if(isEffect) {
                    captureBuilder.set(CaptureRequest.CONTROL_EFFECT_MODE, mEffectId);
            }
