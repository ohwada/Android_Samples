 ...
 */
public class VideoStreamBase extends MediaStream {

	protected final static String TAG = "AbstractVideoStreamBase";
	...
	public VideoStreamBase(int camera) {
		super();
		setCamera(camera);
	}
	...
	public void setPreferences(SharedPreferences prefs) {
        boolean ret = (prefs == null)?false:true;
		Log.d(TAG,"setPreferences: " + ret);
		mSettings = prefs;
	}
	 ...
	 */
	protected void openCamera() throws RuntimeException {
