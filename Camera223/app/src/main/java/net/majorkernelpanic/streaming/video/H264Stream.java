...
// 2019-08-01
        MediaCodec mediaCodec = createMediaCodec(MIME_TYPE, mQuality.resX, mQuality.resY);

        HwEncoderDebugger debugger = new HwEncoderDebugger(mSettings, mQuality.resX, mQuality.resY);
        debugger.debug(mediaCodec);

        String b64SPS = debugger.getB64SPS();
        String b64PPS = debugger.getB64PPS();
		Log.d(TAG, "b64SPS= " + b64SPS + ", b64PPS=" + b64PPS);
...
// 2019-08-01
			...
			HwEncoderDebugger debugger = HwEncoderDebugger.debug(mSettings, mQuality.resX, mQuality.resY);
 ...
 */
	private MP4Config testMediaRecorderAPI() throws RuntimeException, IOException {
        ...
        //File file = VideoFile.getOutputFile(mContext);
		//final String TESTFILE = file.toString();
