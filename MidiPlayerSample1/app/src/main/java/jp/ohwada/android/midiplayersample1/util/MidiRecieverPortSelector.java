...
/**
 * class MidiRecieverPortSelector
 */
public class MidiRecieverPortSelector extends MidiPortSelector {

// debug
    private final static boolean D = true;
	private final static String TAG = "Midi";
	private final static String TAG_SUB = "MidiRecieverPortSelector";
   ...
   /*
     ...
     */
    public MidiRecieverPortSelector(MidiManager midiManager, Activity activity,
            int spinnerId) {
