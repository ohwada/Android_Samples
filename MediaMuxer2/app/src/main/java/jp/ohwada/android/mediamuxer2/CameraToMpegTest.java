 ...
 * original : https://bigflake.com/mediacodec/CameraToMpegTest.java.txt
 */
public class CameraToMpegTest  {
     ...
     * constractor
     */
public CameraToMpegTest(Context context, Callback callback)  {
    mContext = context;
    mCallback = callback;
}

    /** test entry point */
    public void testEncodeCameraToMp4(int width, int height, int bitRate)  throws Throwable {
        mWidth = width;
        mHeight = height;
        mBitRate = bitRate;
    ...
    private static class CameraToMpegWrapper implements Runnable {
        ...
        public void run() {
            try {
                mTest.encodeCameraToMpeg(mWidth, mHeight, mBitRate);
            } catch (Throwable th) {
                mThrowable = th;
            }
        }
        ...
        public static void runTest(CameraToMpegTest obj) throws Throwable {
            ...
            // https://stackoverflow.com/questions/22457623/surfacetextures-onframeavailable-method-always-called-too-late
            // th.join();
     ...
     */
    private void encodeCameraToMpeg(int encWidth, int encHeight, int encBitRate) {
...
private String createOutputFilePath(int width, int height) {
    ...
    private void releaseEncoder() {
        ...
        if (mCallback != null) {
            mCallback.onFinish("releaseEncoder");
        }
    }
