 ...
 */
package jp.ohwada.android.renderscript2;
...
public class MainActivity extends Activity {
    ...
    private final static float SEEKBAR_MAX = 100.0f;
    private final static int SEEKBAR_DEFAULT = 50;

    private final static float BLUR_MAX = 25.0f;
    private final static float BLUR_MIN = 1.f;

    private final static float CONVOLVE_MAX = 2.f;
    private final static float CONVOLVE_MIN = 0.f;

    private final static float COLORMATRIX_MAX = (float) Math.PI;
    private final static float COLORMATRIX_MIN = (float) -Math.PI;

    private final static int THUMBNAIL_WIDTH = 72;
    private final static int THUMBNAIL_HEIGHT = 96;
    private final static float THUMBNAIL_OFFSET = 0.5f;
    ...
    private final static int MODE_BLUR = 0;
    private final static int MODE_CONVOLVE = 1;
    private final static int MODE_COLORMATRIX = 2;
...
/**
  ...
  */
    ...
    private float getFilterParameter(int i) {
        ...
        switch (mFilterMode) {
            case MODE_BLUR: {
                f = getFilterParameter2(i, BLUR_MAX, BLUR_MIN);
            }
            break;
            case MODE_CONVOLVE: {
                f = getFilterParameter2(i, CONVOLVE_MAX, CONVOLVE_MIN);
            }
            break;
            case MODE_COLORMATRIX: {
                f = getFilterParameter2(i, COLORMATRIX_MAX, COLORMATRIX_MIN);
            }
            break;
        }
        return f;
...
/**
     * getFilterParameter2
*/
private float getFilterParameter2(int i, float max, float min) {
    float f = (float) ((max - min) * (i / SEEKBAR_MAX) + min);
    return f;
}
...
/**
  ...
  */
    ...
    private void createThumbnail() {
        ...
        int pixelsWidth = (int) (THUMBNAIL_WIDTH * scale + THUMBNAIL_OFFSET);
        int pixelsHeight = (int) (THUMBNAIL_HEIGHT * scale + THUMBNAIL_OFFSET);
